...
def show_start_screen():
    screen.fill(BLUE)
    draw_text('Brick Breaker', title_font, WHITE, screen, 400, 200)
    draw_text('Press any key to start', instruction_font, WHITE, screen, 400, 400)
    pygame.display.flip()
    waiting = True
    while waiting:
...
def show_game_over_screen():
    screen.fill(RED)
    draw_text('Game Over', title_font, WHITE, screen, 400, 200)
    draw_text('Press any key to restart', instruction_font, WHITE, screen, 400, 400)
    pygame.display.flip()
    waiting = True
    while waiting:
        for event in pygame.event.get():
